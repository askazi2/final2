...
public class NewActivity {
    ...
    protected void onResume() {
        ...
        mProductArrayList.add(new EpisodeName("a"));
        mProductArrayList.add(new EpisodeName("b"));
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.tvName.setText(mDisplayedValues.get(position).title);
            ...
            holder.llContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(NewActivity.this, mDisplayedValues.get(position).title, Toast.LENGTH_SHORT).show();
                }
            });
                    ...
                    if (constraint == null || constraint.length() == 0) {
                        ...
                        for (int i = 0; i < mOriginalValues.size(); i++) {
                            ...
                            if (data.toLowerCase().startsWith(constraint.toString())) {
                                ...
                                FilteredArrList.add(new EpisodeName(mOriginalValues.get(i).title));
                            }
                        }
